...
Page({
  ...
  onLoad(options) {
    Get(api.GetOrderParticulars, {
      ...
      this.setData({
        address: res.data.Data.addressManage,
        detail: res.data.Data.previewOrderView[0],
        status: res.data.Data.previewOrderView[0].Status,
        ShipCompany: res.data.Data.ShipCompany,
