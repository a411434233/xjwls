...
Page({
  ...
  async onLoad(options) {
    if (options.id) {
      ...
      this.setData({ id: options.id, provinces: res.data.Data.Province, city: res.data.Data.City, area: res.data.Data.Area, addressdetail: res.data.Data.Address, name: res.data.Data.UserName, telphone: res.data.Data.Tel, is_default: res.data.Data.IsDefault, isShowDel: true });
    }
  },
  onShow() {
